      ...
      <section className="bg-surface-container-high relative p-6 solder-point solder-tl solder-tr solder-bl solder-br border border-[#32152f] h-full flex flex-col">
        ...
        <div className="grid grid-cols-4 gap-6 flex-1">
          ...
          <div className="space-y-4">
            <div className="h-48 bg-surface-container-lowest relative flex flex-col justify-end p-1 group has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary has-[:focus-visible]:ring-offset-2 has-[:focus-visible]:ring-offset-surface-container-high">
          ...
          <div className="flex flex-col items-center gap-4 group">
            <div className="h-48 w-8 bg-surface-container-lowest relative rounded-full border border-tertiary/20 p-1 cursor-pointer has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary has-[:focus-visible]:ring-offset-2 has-[:focus-visible]:ring-offset-surface-container-high">
          ...
          {/* Pitch Bend Slider */}
          <div className="flex flex-col items-center gap-4 group">
            <div className="h-48 w-8 bg-surface-container-lowest relative rounded-full border border-secondary/20 p-1 cursor-pointer has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary has-[:focus-visible]:ring-offset-2 has-[:focus-visible]:ring-offset-surface-container-high">
  ...
  return (
    <section className="bg-surface-container-high relative p-6 solder-point solder-tl solder-tr solder-bl solder-br border border-[#32152f] h-full flex flex-col">
      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        <div className="relative w-32 h-32 flex items-center justify-center shrink-0 group has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary has-[:focus-visible]:ring-offset-2 has-[:focus-visible]:ring-offset-surface-container-high rounded-full">
        ...
        <div className="flex-1 space-y-6 w-full">
          ...
          <div className="bg-surface-container-lowest p-3 border-l-4 border-secondary relative group has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-primary has-[:focus-visible]:ring-offset-2 has-[:focus-visible]:ring-offset-surface-container-high">
