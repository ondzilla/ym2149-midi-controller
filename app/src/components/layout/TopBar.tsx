      ...
      <div className="flex items-center gap-6">
        <div className="flex gap-4">
          <button
            ...
            aria-label="Settings"
            title="Settings"
            className="text-[#ff9cf4] opacity-70 cursor-pointer hover:text-[#8eff71] focus-visible:text-[#8eff71] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded transition-colors flex items-center justify-center"
          >
