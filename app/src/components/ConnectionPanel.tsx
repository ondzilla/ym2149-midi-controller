      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span data-testid="connection-status" role="status" aria-live="polite" className={`font-headline text-[10px] tracking-widest ${activeOutId ? 'text-primary' : 'text-error'}`}>
          ...
          {experimentalGamepad && (
            <div className="flex items-center gap-2 border-l border-outline-variant/20 pl-4">
              ...
              <span data-testid="gamepad-status" role="status" aria-live="polite" className={`font-headline text-[10px] tracking-widest ${gamepadConnected ? 'text-primary' : 'text-error'}`}>
