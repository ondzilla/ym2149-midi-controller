...
describe('DrumPads', () => {
  it('should trigger Note E3 on Channel 10 when Kick Drum pad is clicked', async () => {
    ...
    // Channel 10, Note 64 (E3), full velocity
    ...
    expect(midiService.sendNoteOff).toHaveBeenCalledWith(10, 64, 0);
  });
  ...
  it('should trigger Note D#3 on Channel 10 for Snare', async () => {
    ...
    expect(midiService.sendNoteOn).toHaveBeenCalledWith(10, 63, 127);
  });
  ...
  it('should trigger Note C3 on Channel 10 for Dog Yap', async () => {
    ...
    expect(midiService.sendNoteOn).toHaveBeenCalledWith(10, 60, 127);
    expect(midiService.sendNoteOff).toHaveBeenCalledWith(10, 60, 0);
  });
  ...
  it('should send noteOff when mouse leaves the pad', async () => {
    ...
    expect(midiService.sendNoteOff).toHaveBeenCalledWith(10, 63, 0);
  });
