...
export const GlobalSettings: React.FC = () => {
  ...
  const [qwertyKeyboard, setQwertyKeyboard] = usePatchState('experimentalQwertyKeyboard', false);
  ...
  const handleQwertyKeyboard = () => {
    setQwertyKeyboard(!qwertyKeyboard);
  };
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <SettingToggle
          label="QWERTY Piano"
          isActive={qwertyKeyboard}
          onClick={handleQwertyKeyboard}
          buttonText="Toggle QWERTY Keyboard"
          activeText="ENABLED"
          inactiveText="DISABLED"
          activeColorClass="bg-secondary"
          activeShadowClass="shadow-[0_0_10px_#f5ce53]"
